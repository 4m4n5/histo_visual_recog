...
# Parameters
PATH = '/project/DSone/as3ek/data/WSI/cinn_normal_zif/'
patch_size = 1000
resize_to = 1000
target = '/project/DSone/as3ek/data/WSI_patched/cinn_normal_zif/' # for WSI
target_path_unnorm = '/project/DSone/as3ek/data/patches/1000/un_normalized/cinn_normal_zif/' # for unnormalized patches
thresh = 0.40
save_WSI = False
